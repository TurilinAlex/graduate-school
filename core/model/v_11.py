...
class ExtremesContainer:
    ...
    def search_extremes(
        ...
        self._extract_all_extremes_from_diff()
        if callable(border_check):
            self._remove_disputed_extremes_border(border_check=border_check)
    ...
    def _extract_all_extremes_from_diff(self):
    ...
    def _remove_disputed_extremes_border(self, border_check: Callable):
        ...
        _batch = len(self._diff_min_extr)
        for index, extr in enumerate(self._extr_all_index):
...
def main():
    ...
    for i in range(1):
        ...
        print(trend_combined.get_combined_indexes())
