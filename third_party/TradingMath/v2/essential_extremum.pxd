...
cdef void __diff_between_all_indexes(const DLONGINTTYPE_t[::1] index, DLONGINTTYPE_t[::1] min_extr_diff_view, DLONGINTTYPE_t[::1] max_extr_diff_view, DLONGINTTYPE_t[::1] min_count, DLONGINTTYPE_t[::1] max_count, const DLONGINTTYPE_t n, const DLONGINTTYPE_t eps) noexcept nogil

cdef void __diff_between_all_indexes_parallel(const DLONGINTTYPE_t[::1] index, DLONGINTTYPE_t[::1] min_extr_diff_view, DLONGINTTYPE_t[::1] max_extr_diff_view, DLONGINTTYPE_t[::1] min_count, DLONGINTTYPE_t[::1] max_count, const DLONGINTTYPE_t &n, const DLONGINTTYPE_t &eps) noexcept nogil
